...
#    Updated: 2017/09/29 21:09:22 by sadamant         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRC = ft_atoi.c ft_bzero.c ft_checkend.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	  ...
	  ft_putstr.c ft_putstr_fd.c ft_stralloc.c ft_strcat.c ft_strchr.c ft_strclr.c \
